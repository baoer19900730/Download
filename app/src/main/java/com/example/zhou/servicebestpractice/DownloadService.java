    ...
    class DownloadBinder extends Binder{
        ...
        public void startDownload(String url){
            if (downloadTask == null){
                ...
                downloadTask.execute(downlodUrl);
                startForeground(1, getNotification("Downloading...", 0));
                Toast.makeText(DownloadService.this, "Downing...", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void cancelDownload(){
            if (downloadTask != null){
                ...
                if (downlodUrl != null){
                    String fileName = downlodUrl.substring(downlodUrl.lastIndexOf("/"));
